...
<body>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                  ...
                  <li>
                    ...
                    <li>
                        <a href="todropCourse.action" class="active-menu"><i class="fa fa-edit"></i> 退选课程 </a>
                    </li>
                </ul>
    ...
    <!-- NAV SIDE LEFT END -->
    <!-- PAGE SIDE-->
          <form action=dropCourse.action>
            <div id="page-wrapper" >
            <div id="page-inner">
             <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            退选课程 <small>退选你不需要的课程</small>
                        </h1>
                    </div>
                </div> 
                 <!-- /. ROW  -->
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                          <c:forEach items="${sessionScope.student.getCourses()}" var="course" varStatus="loop">
                         <tr class="success">
