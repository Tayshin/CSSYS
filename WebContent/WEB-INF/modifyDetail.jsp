...
<body>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                   ...
                   <li>
                    ...
                    <li>
                        <a href="tomodifyDetail.action"  class="active-menu"><i class="fa fa-desktop"></i> 修改个人信息</a>
                    </li>
                    <li>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="col-md-12 column">
                                    <form role="form" action="changePassword.action">
                                       ...
                                       <button id="submitBtn" type="submit" class="btn btn-info" disbaled="disabled">提交</button>
                                        </form>
                                </div>
                             </div>
                    </div>
    ...
    <script src="js/modifyDetail.js"></script>
      <!-- Bootstrap Js -->
